...
# background
python sim_data_generator.py ${BLENDER_PROC_PATH} ${BOP_MODEL_PATH} train background ${SIM_ID} 51 20 ${OBJ_START_ID} ${OBJ_END_ID} ${MODEL_MM} --background True --obj_num 40  --box_width 0.4
python sim_data_generator.py ${BLENDER_PROC_PATH} ${BOP_MODEL_PATH} val background ${SIM_ID} 6 2 ${OBJ_START_ID} ${OBJ_END_ID} ${MODEL_MM} --background True --obj_num 40 --box_width 0.4
