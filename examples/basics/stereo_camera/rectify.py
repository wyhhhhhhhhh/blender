...
# convert_all_to_dotav1("./", "psm-sim{}-train".format(dataid), str(dataid), 100, "train", "sim{}_DotaV1".format(dataid))
# convert_all_to_dotav1("./", "psm-sim{}-val".format(dataid), str(dataid), 10, "val", "sim{}_DotaV1".format(dataid))