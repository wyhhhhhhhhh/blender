...
generate(){
    ...
    mkdir ${scene_id}
    echo $1;
    blenderproc run ${BLENDERPROC_PATH}examples/basics/stereo_camera/generator.py ${BOP_MODEL_PATH}${SIM_ID}/ "lm" ${MODEL_MM} ${BLENDERPROC_PATH}resources/cc0_textures ${BLENDERPROC_PATH}resources/coco ${OBJ_ID} ${GEN_NUM} ${scene_id} ${BACKGROUND} ${BOX_WIDTH}
}
